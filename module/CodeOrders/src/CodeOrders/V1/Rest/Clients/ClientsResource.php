...
class ClientsResource extends AbstractResourceListener
{
    ...
    public function create($data)
    {
        ...
        if($user->getRole()!='administrador'){
            return new ApiProblem(405, "Only administrator can create new clients.");
        }
    ...
    public function delete($id)
    {
        $user = $this->usersRepository->findByUsername($this->getIdentity()->getRoleId());
        if($user->getRole()!='administrador'){
            return new ApiProblem(405, "Only administrator can delete clients.");
        }
    ...
    public function update($id, $data)
    {
        $user = $this->usersRepository->findByUsername($this->getIdentity()->getRoleId());
        if($user->getRole()!='administrador'){
            return new ApiProblem(405, "Only administrator can update clients.");
        }
